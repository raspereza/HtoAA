...
void CorrCoefficientsMC(
			bool signalRegion = false,
			bool btagVeto = false
			) {

  TString dir("/nfs/dust/cms/user/rasp/Run/Run2018/H2aa/QCD_Model");
  ...
  TString SamplesMuEnrichedQCD[11] = {"QCD_Pt-15to20_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-20to30_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-30to50_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-50to80_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-80to120_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-120to170_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-170to300_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-300to470_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-470to600_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-600to800_MuEnrichedPt5_13TeV",
                                      "QCD_Pt-800to1000_MuEnrichedPt5_13TeV"};
  
  double xsecMuEnrichedQCD[11] = {1273190000*0.003,
                                  558528000*0.0053,
                                  139803000*0.01182,
                                  19222500*0.02276,
                                  2758420*0.03844,
