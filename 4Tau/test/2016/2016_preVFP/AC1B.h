...
// Sun Mar 19 15:23:32 2023 by ROOT version 6.12/07
// from TTree AC1B/AC1B
// found on file: /pnfs/desy.de/cms/tier2/store/user/acardini/ntuples/Oktoberfest21/2016_preVFP/mc/TTTo2L2Nu/TTTo2L2Nu_122.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         refitvertex_x[45];   //[refitvertex_count]
   Float_t         refitvertex_y[45];   //[refitvertex_count]
   Float_t         refitvertex_z[45];   //[refitvertex_count]
   Float_t         refitvertex_chi2[45];   //[refitvertex_count]
   Float_t         refitvertex_ndof[45];   //[refitvertex_count]
   Int_t           refitvertex_ntracks[45];   //[refitvertex_count]
   Float_t         refitvertex_cov[45][6];   //[refitvertex_count]
   Int_t           refitvertex_eleIndex[45][2];   //[refitvertex_count]
   Int_t           refitvertex_muIndex[45][2];   //[refitvertex_count]
   Int_t           refitvertex_tauIndex[45][2];   //[refitvertex_count]
   UInt_t          refitvertexwithbs_count;
   Float_t         refitvertexwithbs_x[45];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_y[45];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_z[45];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_chi2[45];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_ndof[45];   //[refitvertexwithbs_count]
   Int_t           refitvertexwithbs_ntracks[45];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_cov[45][6];   //[refitvertexwithbs_count]
   Int_t           refitvertexwithbs_eleIndex[45][2];   //[refitvertexwithbs_count]
   Int_t           refitvertexwithbs_muIndex[45][2];   //[refitvertexwithbs_count]
   Int_t           refitvertexwithbs_tauIndex[45][2];   //[refitvertexwithbs_count]
   UInt_t          muon_count;
   Float_t         muon_helixparameters[13][5];   //[muon_count]
   Float_t         muon_helixparameters_covar[13][5][5];   //[muon_count]
   Float_t         muon_referencePoint[13][3];   //[muon_count]
   Float_t         muon_Bfield[13];   //[muon_count]
   Float_t         muon_px[13];   //[muon_count]
   Float_t         muon_py[13];   //[muon_count]
   Float_t         muon_pz[13];   //[muon_count]
   Float_t         muon_pt[13];   //[muon_count]
   Float_t         muon_eta[13];   //[muon_count]
   Float_t         muon_phi[13];   //[muon_count]
   Float_t         muon_pterror[13];   //[muon_count]
   Float_t         muon_chi2[13];   //[muon_count]
   Float_t         muon_normChi2[13];   //[muon_count]
   Float_t         muon_ndof[13];   //[muon_count]
   Float_t         muon_charge[13];   //[muon_count]
   Float_t         muon_miniISO[13];   //[muon_count]
   Float_t         muon_combQ_chi2LocalPosition[13];   //[muon_count]
   Float_t         muon_combQ_trkKink[13];   //[muon_count]
   Float_t         muon_validFraction[13];   //[muon_count]
   Float_t         muon_segmentComp[13];   //[muon_count]
   UInt_t          muon_nMuonStations[13];   //[muon_count]
   UInt_t          muon_nMuonHits[13];   //[muon_count]
   UInt_t          muon_nPixelHits[13];   //[muon_count]
   UInt_t          muon_nTrackerHits[13];   //[muon_count]
   Float_t         muon_dxy[13];   //[muon_count]
   Float_t         muon_dxyerr[13];   //[muon_count]
   Float_t         muon_dz[13];   //[muon_count]
   Float_t         muon_dzerr[13];   //[muon_count]
   Float_t         muon_vx[13];   //[muon_count]
   Float_t         muon_vy[13];   //[muon_count]
   Float_t         muon_vz[13];   //[muon_count]
   Float_t         muon_chargedHadIso[13];   //[muon_count]
   Float_t         muon_neutralHadIso[13];   //[muon_count]
   Float_t         muon_photonIso[13];   //[muon_count]
   Float_t         muon_puIso[13];   //[muon_count]
   Float_t         muon_r03_sumChargedHadronPt[13];   //[muon_count]
   Float_t         muon_r03_sumChargedParticlePt[13];   //[muon_count]
   Float_t         muon_r03_sumNeutralHadronEt[13];   //[muon_count]
   Float_t         muon_r03_sumPhotonEt[13];   //[muon_count]
   Float_t         muon_r03_sumNeutralHadronEtHighThreshold[13];   //[muon_count]
   Float_t         muon_r03_sumPhotonEtHighThreshold[13];   //[muon_count]
   Float_t         muon_r03_sumPUPt[13];   //[muon_count]
   Float_t         muon_r04_sumChargedHadronPt[13];   //[muon_count]
   Float_t         muon_r04_sumChargedParticlePt[13];   //[muon_count]
   Float_t         muon_r04_sumNeutralHadronEt[13];   //[muon_count]
   Float_t         muon_r04_sumPhotonEt[13];   //[muon_count]
   Float_t         muon_r04_sumNeutralHadronEtHighThreshold[13];   //[muon_count]
   Float_t         muon_r04_sumPhotonEtHighThreshold[13];   //[muon_count]
   Float_t         muon_r04_sumPUPt[13];   //[muon_count]
   Bool_t          muon_isPF[13];   //[muon_count]
   Bool_t          muon_isGlobal[13];   //[muon_count]
   Bool_t          muon_isTracker[13];   //[muon_count]
   Bool_t          muon_isTight[13];   //[muon_count]
   Bool_t          muon_isLoose[13];   //[muon_count]
   Bool_t          muon_isMedium[13];   //[muon_count]
   Int_t           muon_genmatch[13];   //[muon_count]
   Bool_t          muon_isDuplicate[13];   //[muon_count]
   Bool_t          muon_isBad[13];   //[muon_count]
   Float_t         muon_ttHMVA[13];   //[muon_count]
   Float_t         muon_ttHMVA2016[13];   //[muon_count]
   UInt_t          pfjet_count;
   ...
   Float_t         pfjetpuppi_e[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_px[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_py[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_pz[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_pt[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_eta[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_phi[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_neutralhadronicenergy[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_chargedhadronicenergy[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_neutralemenergy[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_chargedemenergy[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_muonenergy[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_chargedmuonenergy[17];   //[pfjetpuppi_count]
   UInt_t          pfjetpuppi_chargedmulti[17];   //[pfjetpuppi_count]
   UInt_t          pfjetpuppi_neutralmulti[17];   //[pfjetpuppi_count]
   UInt_t          pfjetpuppi_chargedhadronmulti[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr_l1fastjet[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr_l2relative[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr_l3absolute[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr_l2l3residual[17];   //[pfjetpuppi_count]
   Int_t           pfjetpuppi_flavour[17];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_btag[17][10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_jecUncertainty[17];   //[pfjetpuppi_count]
   UInt_t          electron_count;
   Float_t         electron_helixparameters[6][5];   //[electron_count]
   Float_t         electron_helixparameters_covar[6][5][5];   //[electron_count]
   Float_t         electron_referencePoint[6][3];   //[electron_count]
   Float_t         electron_Bfield[6];   //[electron_count]
   Float_t         electron_px[6];   //[electron_count]
   Float_t         electron_py[6];   //[electron_count]
   Float_t         electron_pz[6];   //[electron_count]
   Float_t         electron_pt[6];   //[electron_count]
   Float_t         electron_eta[6];   //[electron_count]
   Float_t         electron_phi[6];   //[electron_count]
   Float_t         electron_px_energyscale_up[6];   //[electron_count]
   Float_t         electron_px_energyscale_down[6];   //[electron_count]
   Float_t         electron_py_energyscale_up[6];   //[electron_count]
   Float_t         electron_py_energyscale_down[6];   //[electron_count]
   Float_t         electron_pz_energyscale_up[6];   //[electron_count]
   Float_t         electron_pz_energyscale_down[6];   //[electron_count]
   Float_t         electron_pt_energyscale_up[6];   //[electron_count]
   Float_t         electron_pt_energyscale_down[6];   //[electron_count]
   Float_t         electron_px_energysigma_up[6];   //[electron_count]
   Float_t         electron_px_energysigma_down[6];   //[electron_count]
   Float_t         electron_py_energysigma_up[6];   //[electron_count]
   Float_t         electron_py_energysigma_down[6];   //[electron_count]
   Float_t         electron_pz_energysigma_up[6];   //[electron_count]
   Float_t         electron_pz_energysigma_down[6];   //[electron_count]
   Float_t         electron_pt_energysigma_up[6];   //[electron_count]
   Float_t         electron_pt_energysigma_down[6];   //[electron_count]
   Float_t         electron_trackchi2[6];   //[electron_count]
   Float_t         electron_trackndof[6];   //[electron_count]
   Float_t         electron_outerx[6];   //[electron_count]
   Float_t         electron_outery[6];   //[electron_count]
   Float_t         electron_outerz[6];   //[electron_count]
   Float_t         electron_vx[6];   //[electron_count]
   Float_t         electron_vy[6];   //[electron_count]
   Float_t         electron_vz[6];   //[electron_count]
   Float_t         electron_esuperclusterovertrack[6];   //[electron_count]
   Float_t         electron_eseedclusterovertrack[6];   //[electron_count]
   Float_t         electron_deltaetasuperclustertrack[6];   //[electron_count]
   Float_t         electron_deltaphisuperclustertrack[6];   //[electron_count]
   Float_t         electron_e1x5[6];   //[electron_count]
   Float_t         electron_e2x5[6];   //[electron_count]
   Float_t         electron_e5x5[6];   //[electron_count]
   Float_t         electron_sigmaetaeta[6];   //[electron_count]
   Float_t         electron_sigmaietaieta[6];   //[electron_count]
   Float_t         electron_ehcaloverecal[6];   //[electron_count]
   Float_t         electron_ehcaloverecaldepth1[6];   //[electron_count]
   Float_t         electron_ehcaloverecaldepth2[6];   //[electron_count]
   Float_t         electron_full5x5_sigmaietaieta[6];   //[electron_count]
   Float_t         electron_ooemoop[6];   //[electron_count]
   Float_t         electron_miniISO[6];   //[electron_count]
   Float_t         electron_superclusterEta[6];   //[electron_count]
   Float_t         electron_superclusterPhi[6];   //[electron_count]
   Float_t         electron_superclusterX[6];   //[electron_count]
   Float_t         electron_superclusterY[6];   //[electron_count]
   Float_t         electron_superclusterZ[6];   //[electron_count]
   Float_t         electron_detaInSeed[6];   //[electron_count]
   Float_t         electron_he[6];   //[electron_count]
   Float_t         electron_eaIsolation[6];   //[electron_count]
   Float_t         electron_chargedHadIso[6];   //[electron_count]
   Float_t         electron_neutralHadIso[6];   //[electron_count]
   Float_t         electron_photonIso[6];   //[electron_count]
   Float_t         electron_puIso[6];   //[electron_count]
   Float_t         electron_r03_sumChargedHadronPt[6];   //[electron_count]
   Float_t         electron_r03_sumChargedParticlePt[6];   //[electron_count]
   Float_t         electron_r03_sumNeutralHadronEt[6];   //[electron_count]
   Float_t         electron_r03_sumPhotonEt[6];   //[electron_count]
   Float_t         electron_r03_sumNeutralHadronEtHighThreshold[6];   //[electron_count]
   Float_t         electron_r03_sumPhotonEtHighThreshold[6];   //[electron_count]
   Float_t         electron_r03_sumPUPt[6];   //[electron_count]
   UChar_t         electron_nhits[6];   //[electron_count]
   UChar_t         electron_npixelhits[6];   //[electron_count]
   UChar_t         electron_nmissinghits[6];   //[electron_count]
   UChar_t         electron_nmissinginnerhits[6];   //[electron_count]
   UChar_t         electron_npixellayers[6];   //[electron_count]
   UChar_t         electron_nstriplayers[6];   //[electron_count]
   Float_t         electron_dxy[6];   //[electron_count]
   Float_t         electron_dxyerr[6];   //[electron_count]
   Float_t         electron_dz[6];   //[electron_count]
   Float_t         electron_dzerr[6];   //[electron_count]
   Float_t         electron_convdist[6];   //[electron_count]
   UInt_t          electron_gapinfo[6];   //[electron_count]
   UInt_t          electron_chargeinfo[6];   //[electron_count]
   Float_t         electron_fbrems[6];   //[electron_count]
   Int_t           electron_numbrems[6];   //[electron_count]
   Float_t         electron_charge[6];   //[electron_count]
   Int_t           electron_superclusterindex[6];   //[electron_count]
   UChar_t         electron_info[6];   //[electron_count]
   Bool_t          electron_cutId_veto_Summer16[6];   //[electron_count]
   Float_t         electron_mva_value_Spring16_v1[6];   //[electron_count]
   Float_t         electron_mva_wp90_general_Spring16_v1[6];   //[electron_count]
   Float_t         electron_mva_wp80_general_Spring16_v1[6];   //[electron_count]
   Float_t         electron_mva_value_Iso_Fall17_v1[6];   //[electron_count]
   Float_t         electron_mva_value_noIso_Fall17_v1[6];   //[electron_count]
   Float_t         electron_mva_wp90_Iso_Fall17_v1[6];   //[electron_count]
   Float_t         electron_mva_wp80_Iso_Fall17_v1[6];   //[electron_count]
   Float_t         electron_mva_Loose_Iso_Fall17_v1[6];   //[electron_count]
   Float_t         electron_mva_wp90_noIso_Fall17_v1[6];   //[electron_count]
   Float_t         electron_mva_wp80_noIso_Fall17_v1[6];   //[electron_count]
   Float_t         electron_mva_Loose_noIso_Fall17_v1[6];   //[electron_count]
   Float_t         electron_mva_value_Iso_Fall17_v2[6];   //[electron_count]
   Float_t         electron_mva_value_noIso_Fall17_v2[6];   //[electron_count]
   Float_t         electron_mva_wp90_Iso_Fall17_v2[6];   //[electron_count]
   Float_t         electron_mva_wp80_Iso_Fall17_v2[6];   //[electron_count]
   Float_t         electron_mva_Loose_Iso_Fall17_v2[6];   //[electron_count]
   Float_t         electron_mva_wp90_noIso_Fall17_v2[6];   //[electron_count]
   Float_t         electron_mva_wp80_noIso_Fall17_v2[6];   //[electron_count]
   Float_t         electron_mva_Loose_noIso_Fall17_v2[6];   //[electron_count]
   Bool_t          electron_cutId_veto_Fall17[6];   //[electron_count]
   Bool_t          electron_cutId_veto_Fall17V2[6];   //[electron_count]
   Float_t         electron_ttHMVA[6];   //[electron_count]
   Float_t         electron_ttHMVA2016[6];   //[electron_count]
   Bool_t          electron_pass_conversion[6];   //[electron_count]
   Int_t           electron_genmatch[6];   //[electron_count]
   UInt_t          tau_count;
   Float_t         tau_helixparameters[9][5];   //[tau_count]
   Float_t         tau_helixparameters_covar[9][5][5];   //[tau_count]
   Float_t         tau_referencePoint[9][3];   //[tau_count]
   Float_t         tau_Bfield[9];   //[tau_count]
   Float_t         tau_e[9];   //[tau_count]
   Float_t         tau_px[9];   //[tau_count]
   Float_t         tau_py[9];   //[tau_count]
   Float_t         tau_pz[9];   //[tau_count]
   Float_t         tau_mass[9];   //[tau_count]
   Float_t         tau_eta[9];   //[tau_count]
   Float_t         tau_phi[9];   //[tau_count]
   Float_t         tau_pt[9];   //[tau_count]
   Float_t         tau_vertexx[9];   //[tau_count]
   Float_t         tau_vertexy[9];   //[tau_count]
   Float_t         tau_vertexz[9];   //[tau_count]
   Float_t         tau_pca2D_x[9];   //[tau_count]
   Float_t         tau_pca2D_y[9];   //[tau_count]
   Float_t         tau_pca2D_z[9];   //[tau_count]
   Float_t         tau_pca3D_x[9];   //[tau_count]
   Float_t         tau_pca3D_y[9];   //[tau_count]
   Float_t         tau_pca3D_z[9];   //[tau_count]
   Float_t         tau_dxy[9];   //[tau_count]
   Float_t         tau_dxySig[9];   //[tau_count]
   Float_t         tau_dz[9];   //[tau_count]
   Float_t         tau_ip3d[9];   //[tau_count]
   Float_t         tau_ip3dSig[9];   //[tau_count]
   Float_t         tau_charge[9];   //[tau_count]
   Float_t         tau_flightLength[9];   //[tau_count]
   Float_t         tau_flightLengthSig[9];   //[tau_count]
   Float_t         tau_SV_x[9];   //[tau_count]
   Float_t         tau_SV_y[9];   //[tau_count]
   Float_t         tau_SV_z[9];   //[tau_count]
   Float_t         tau_SV_cov[9][6];   //[tau_count]
   Float_t         tau_genjet_px[9];   //[tau_count]
   Float_t         tau_genjet_py[9];   //[tau_count]
   Float_t         tau_genjet_pz[9];   //[tau_count]
   Float_t         tau_genjet_e[9];   //[tau_count]
   Int_t           tau_genmatch[9];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_px[9];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_py[9];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_pz[9];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_mass[9];   //[tau_count]
   Int_t           tau_leadchargedhadrcand_id[9];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_dxy[9];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_dz[9];   //[tau_count]
   Int_t           tau_leadchargedhadrcand_lostPixelHits[9];   //[tau_count]
   Int_t           tau_leadchargedhadrcand_pvAssocQ[9];   //[tau_count]
   Bool_t          tau_L1trigger_match[9];   //[tau_count]
   UInt_t          tau_signalChargedHadrCands_size[9];   //[tau_count]
   UInt_t          tau_signalNeutralHadrCands_size[9];   //[tau_count]
   UInt_t          tau_signalGammaCands_size[9];   //[tau_count]
   UInt_t          tau_isolationChargedHadrCands_size[9];   //[tau_count]
   UInt_t          tau_isolationNeutralHadrCands_size[9];   //[tau_count]
   UInt_t          tau_isolationGammaCands_size[9];   //[tau_count]
   Char_t          tau_genDecayMode_name[9];   //[tau_count]
   Int_t           tau_genDecayMode[9];   //[tau_count]
   Char_t          tau_decayMode_name[9];   //[tau_count]
   Int_t           tau_decayMode[9];   //[tau_count]
   UInt_t          tau_constituents_count[9];   //[tau_count]
   Float_t         tau_constituents_px[9][50];   //[tau_count]
   Float_t         tau_constituents_py[9][50];   //[tau_count]
   Float_t         tau_constituents_pz[9][50];   //[tau_count]
   Float_t         tau_constituents_e[9][50];   //[tau_count]
   Float_t         tau_constituents_mass[9][50];   //[tau_count]
   Int_t           tau_constituents_charge[9][50];   //[tau_count]
   Float_t         tau_constituents_vx[9][50];   //[tau_count]
   Float_t         tau_constituents_vy[9][50];   //[tau_count]
   Float_t         tau_constituents_vz[9][50];   //[tau_count]
   Int_t           tau_constituents_pdgId[9][50];   //[tau_count]
   Int_t           tau_constituents_lostPixelHits[9][50];   //[tau_count]
   UInt_t          track_count;
   Float_t         track_px[176];   //[track_count]
   Float_t         track_py[176];   //[track_count]
   Float_t         track_pz[176];   //[track_count]
   Float_t         track_pt[176];   //[track_count]
   Float_t         track_eta[176];   //[track_count]
   Float_t         track_phi[176];   //[track_count]
   Float_t         track_charge[176];   //[track_count]
   Float_t         track_mass[176];   //[track_count]
   Float_t         track_dxy[176];   //[track_count]
   Float_t         track_dxyerr[176];   //[track_count]
   Float_t         track_dz[176];   //[track_count]
   Float_t         track_dzerr[176];   //[track_count]
   Float_t         track_vx[176];   //[track_count]
   Float_t         track_vy[176];   //[track_count]
   Float_t         track_vz[176];   //[track_count]
   Int_t           track_ID[176];   //[track_count]
   Bool_t          track_highPurity[176];   //[track_count]
   ...
   Float_t         genparticles_e[102];   //[genparticles_count]
   Float_t         genparticles_px[102];   //[genparticles_count]
   Float_t         genparticles_py[102];   //[genparticles_count]
   Float_t         genparticles_pz[102];   //[genparticles_count]
   Float_t         genparticles_vx[102];   //[genparticles_count]
   Float_t         genparticles_vy[102];   //[genparticles_count]
   Float_t         genparticles_vz[102];   //[genparticles_count]
   Int_t           genparticles_pdgid[102];   //[genparticles_count]
   Int_t           genparticles_status[102];   //[genparticles_count]
   UInt_t          genparticles_info[102];   //[genparticles_count]
   Int_t           genparticles_fromHardProcess[102];   //[genparticles_count]
   Int_t           genparticles_fromHardProcessBeforeFSR[102];   //[genparticles_count]
   Int_t           genparticles_isDecayedLeptonHadron[102];   //[genparticles_count]
   Int_t           genparticles_isDirectHadronDecayProduct[102];   //[genparticles_count]
   Int_t           genparticles_isDirectHardProcessTauDecayProduct[102];   //[genparticles_count]
   Int_t           genparticles_isDirectPromptTauDecayProduct[102];   //[genparticles_count]
   Int_t           genparticles_isDirectTauDecayProduct[102];   //[genparticles_count]
   Int_t           genparticles_isFirstCopy[102];   //[genparticles_count]
   Int_t           genparticles_isHardProcess[102];   //[genparticles_count]
   Int_t           genparticles_isHardProcessTauDecayProduct[102];   //[genparticles_count]
   Int_t           genparticles_isLastCopy[102];   //[genparticles_count]
   Int_t           genparticles_isLastCopyBeforeFSR[102];   //[genparticles_count]
   Int_t           genparticles_isPrompt[102];   //[genparticles_count]
   Int_t           genparticles_isPromptTauDecayProduct[102];   //[genparticles_count]
   Int_t           genparticles_isTauDecayProduct[102];   //[genparticles_count]
   UChar_t         genparticles_mother[102];   //[genparticles_count]
   ...
   Float_t         l1egamma_px[7];   //[l1egamma_count]
   Float_t         l1egamma_py[7];   //[l1egamma_count]
   Float_t         l1egamma_pz[7];   //[l1egamma_count]
   Float_t         l1egamma_pt[7];   //[l1egamma_count]
   Int_t           l1egamma_eta[7];   //[l1egamma_count]
   Int_t           l1egamma_phi[7];   //[l1egamma_count]
   Int_t           l1egamma_iso[7];   //[l1egamma_count]
   UInt_t          l1tau_count;
   Float_t         l1tau_px[12];   //[l1tau_count]
   Float_t         l1tau_py[12];   //[l1tau_count]
   Float_t         l1tau_pz[12];   //[l1tau_count]
   Float_t         l1tau_pt[12];   //[l1tau_count]
   Int_t           l1tau_ipt[12];   //[l1tau_count]
   Int_t           l1tau_eta[12];   //[l1tau_count]
   Int_t           l1tau_phi[12];   //[l1tau_count]
   Int_t           l1tau_qual[12];   //[l1tau_count]
   Int_t           l1tau_iso[12];   //[l1tau_count]
   Int_t           l1tau_towerIEta[12];   //[l1tau_count]
   Int_t           l1tau_towerIPhi[12];   //[l1tau_count]
   Int_t           l1tau_rawEt[12];   //[l1tau_count]
   Int_t           l1tau_isoEt[12];   //[l1tau_count]
   Int_t           l1tau_nTT[12];   //[l1tau_count]
   Int_t           l1tau_hasEM[12];   //[l1tau_count]
   Int_t           l1tau_isMerged[12];   //[l1tau_count]
   Int_t           l1tau_bx[12];   //[l1tau_count]
   ...
   Float_t         trigobject_px[29];   //[trigobject_count]
   Float_t         trigobject_py[29];   //[trigobject_count]
   Float_t         trigobject_pz[29];   //[trigobject_count]
   Float_t         trigobject_pt[29];   //[trigobject_count]
   Float_t         trigobject_eta[29];   //[trigobject_count]
   Float_t         trigobject_phi[29];   //[trigobject_count]
   Bool_t          trigobject_filters[29][200];   //[trigobject_count]
   Bool_t          trigobject_isMuon[29];   //[trigobject_count]
   Bool_t          trigobject_isElectron[29];   //[trigobject_count]
   Bool_t          trigobject_isTau[29];   //[trigobject_count]
   Bool_t          trigobject_isJet[29];   //[trigobject_count]
   Bool_t          trigobject_isMET[29];   //[trigobject_count]
   ...
   Float_t         tau_againstElectronDeadECAL[9];   //[tau_count]
   Float_t         tau_againstElectronLooseMVA6[9];   //[tau_count]
   Float_t         tau_againstElectronMVA6Raw[9];   //[tau_count]
   Float_t         tau_againstElectronMVA6category[9];   //[tau_count]
   Float_t         tau_againstElectronMediumMVA6[9];   //[tau_count]
   Float_t         tau_againstElectronTightMVA6[9];   //[tau_count]
   Float_t         tau_againstElectronVLooseMVA6[9];   //[tau_count]
   Float_t         tau_againstElectronVTightMVA6[9];   //[tau_count]
   Float_t         tau_againstMuonLoose3[9];   //[tau_count]
   Float_t         tau_againstMuonTight3[9];   //[tau_count]
   Float_t         tau_byCombinedIsolationDeltaBetaCorrRaw3Hits[9];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1DBdR03oldDMwLTraw[9];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1DBnewDMwLTraw[9];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1DBoldDMwLTraw[9];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1PWdR03oldDMwLTraw[9];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1PWnewDMwLTraw[9];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1PWoldDMwLTraw[9];   //[tau_count]
   Float_t         tau_byLooseCombinedIsolationDeltaBetaCorr3Hits[9];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1DBdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1DBnewDMwLT[9];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1DBoldDMwLT[9];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1PWdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1PWnewDMwLT[9];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1PWoldDMwLT[9];   //[tau_count]
   Float_t         tau_byMediumCombinedIsolationDeltaBetaCorr3Hits[9];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1DBdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1DBnewDMwLT[9];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1DBoldDMwLT[9];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1PWdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1PWnewDMwLT[9];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1PWoldDMwLT[9];   //[tau_count]
   Float_t         tau_byPhotonPtSumOutsideSignalCone[9];   //[tau_count]
   Float_t         tau_byTightCombinedIsolationDeltaBetaCorr3Hits[9];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1DBdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1DBnewDMwLT[9];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1DBoldDMwLT[9];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1PWdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1PWnewDMwLT[9];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1PWoldDMwLT[9];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1DBdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1DBnewDMwLT[9];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1DBoldDMwLT[9];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1PWdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1PWnewDMwLT[9];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1PWoldDMwLT[9];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1DBdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1DBnewDMwLT[9];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1DBoldDMwLT[9];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1PWdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1PWnewDMwLT[9];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1PWoldDMwLT[9];   //[tau_count]
   Float_t         tau_byVVLooseIsolationMVArun2v1DBdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byVVLooseIsolationMVArun2v1DBnewDMwLT[9];   //[tau_count]
   Float_t         tau_byVVLooseIsolationMVArun2v1DBoldDMwLT[9];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1DBdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1DBnewDMwLT[9];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1DBoldDMwLT[9];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1PWdR03oldDMwLT[9];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1PWnewDMwLT[9];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1PWoldDMwLT[9];   //[tau_count]
   Float_t         tau_chargedIsoPtSum[9];   //[tau_count]
   Float_t         tau_chargedIsoPtSumdR03[9];   //[tau_count]
   Float_t         tau_decayModeFinding[9];   //[tau_count]
   Float_t         tau_decayModeFindingNewDMs[9];   //[tau_count]
   Float_t         tau_footprintCorrection[9];   //[tau_count]
   Float_t         tau_footprintCorrectiondR03[9];   //[tau_count]
   Float_t         tau_neutralIsoPtSum[9];   //[tau_count]
   Float_t         tau_neutralIsoPtSumWeight[9];   //[tau_count]
   Float_t         tau_neutralIsoPtSumWeightdR03[9];   //[tau_count]
   Float_t         tau_neutralIsoPtSumdR03[9];   //[tau_count]
   Float_t         tau_photonPtSumOutsideSignalCone[9];   //[tau_count]
   Float_t         tau_photonPtSumOutsideSignalConedR03[9];   //[tau_count]
   Float_t         tau_puCorrPtSum[9];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSeraw[9];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSjetraw[9];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSmuraw[9];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSmu[9];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSmu[9];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSmu[9];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSmu[9];   //[tau_count]
   Float_t         tau_byVTightDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVTightDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byVVLooseDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVVLooseDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byVVTightDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVVTightDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byVVVLooseDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVVVLooseDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSeraw[9];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSjetraw[9];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSmuraw[9];   //[tau_count]
   Float_t         tau_byIsolationMVArun2017v2DBoldDMwLTraw2017[9];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSmu[9];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2017v2DBoldDMwLT2017[9];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSmu[9];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2017v2DBoldDMwLT2017[9];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSmu[9];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2017v2DBoldDMwLT2017[9];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSmu[9];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2017v2DBoldDMwLT2017[9];   //[tau_count]
   Float_t         tau_byVTightDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVTightDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2017v2DBoldDMwLT2017[9];   //[tau_count]
   Float_t         tau_byVVLooseDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVVLooseDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byVVLooseIsolationMVArun2017v2DBoldDMwLT2017[9];   //[tau_count]
   Float_t         tau_byVVTightDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVVTightDeepTau2017v2p1VSjet[9];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2017v2DBoldDMwLT2017[9];   //[tau_count]
   Float_t         tau_byVVVLooseDeepTau2017v2p1VSe[9];   //[tau_count]
   Float_t         tau_byVVVLooseDeepTau2017v2p1VSjet[9];   //[tau_count]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/desy.de/cms/tier2/store/user/acardini/ntuples/Oktoberfest21/2016_preVFP/mc/TTTo2L2Nu/TTTo2L2Nu_122.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/desy.de/cms/tier2/store/user/acardini/ntuples/Oktoberfest21/2016_preVFP/mc/TTTo2L2Nu/TTTo2L2Nu_122.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/pnfs/desy.de/cms/tier2/store/user/acardini/ntuples/Oktoberfest21/2016_preVFP/mc/TTTo2L2Nu/TTTo2L2Nu_122.root:/makeroottree");
