...
for i in B C D E F
do
    echo creating file list for data sample DoubleMuon_Run2017${i}
    ls /pnfs/desy.de/cms/tier2/store/user/lsreelat/NTuples/2017/HtoAA/DoubleMuon/DoubleMuon-Run2017${i}-UL2017/*root > DoubleMuon_Run2017${i}
done


#File lists for 2017 UL MC signal samples:
echo creating file lists for HToAA_To4Tau samples
for i in {4..21}
do 
	ls /pnfs/desy.de/cms/tier2/store/user/lsreelat/NTuples/2017/HtoAA/SUSYGluGluToHToAA_AToMuMu_AToTauTau/SUSYGluGluToHToAA_AToMuMu_AToTauTau_M-125_M-${i}/*root > SUSYGluGluToHToAA_AToMuMu_AToTauTau_M-125_M-${i}
	ls /pnfs/desy.de/cms/tier2/store/user/lsreelat/NTuples/2017/HtoAA/SUSYGluGluHToAA_AToTauTau/SUSYGluGluHToAA_AToTauTau_2017_M-125_M-${i}/*root > SUSYGluGluToHToAA_AToTauTau_M-125_M-${i}
	ls /pnfs/desy.de/cms/tier2/store/user/lsreelat/NTuples/2017/HtoAA/SUSYVBFHToAA_AToTauTau/SUSYVBFHToAA_AToTauTau_2017_M-125_M-${i}/*root > SUSYVBFToHToAA_AToTauTau_M-125_M-${i}
	ls /pnfs/desy.de/cms/tier2/store/user/lsreelat/NTuples/2017/HtoAA/SUSYVHToAA_AToTauTau/SUSYVHToAA_AToTauTau_2017_M-125_M-${i}/*root > SUSYVH_HToAA_AToTauTau_M-125_M-${i}
	ls /pnfs/desy.de/cms/tier2/store/user/lsreelat/NTuples/2017/HtoAA/SUSYttHToAA_AToTauTau/SUSYttHToAA_AToTauTau_2017_M-125_M-${i}/*root > SUSYttH_HToAA_AToTauTau_M-125_M-${i}
done
...
do
    ...
    ls /pnfs/desy.de/cms/tier2/store/user/lsreelat/NTuples/2017/HtoAA/QCD/${names_QCD[$j]}/*root > ${names_QCD[$j]}
