...
// Tue Jan  2 12:52:48 2024 by ROOT version 6.12/07
// from TTree AC1B/AC1B
// found on file: /pnfs/desy.de/cms/tier2/store/user/acardini/ntuples/Oktoberfest21/2018/mc/DYJetsToLL_M-50_amcatnlo/DYJetsToLL_M-50_amcatnlo_21005.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         refitvertex_x[28];   //[refitvertex_count]
   Float_t         refitvertex_y[28];   //[refitvertex_count]
   Float_t         refitvertex_z[28];   //[refitvertex_count]
   Float_t         refitvertex_chi2[28];   //[refitvertex_count]
   Float_t         refitvertex_ndof[28];   //[refitvertex_count]
   Int_t           refitvertex_ntracks[28];   //[refitvertex_count]
   Float_t         refitvertex_cov[28][6];   //[refitvertex_count]
   Int_t           refitvertex_eleIndex[28][2];   //[refitvertex_count]
   Int_t           refitvertex_muIndex[28][2];   //[refitvertex_count]
   Int_t           refitvertex_tauIndex[28][2];   //[refitvertex_count]
   UInt_t          refitvertexwithbs_count;
   Float_t         refitvertexwithbs_x[28];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_y[28];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_z[28];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_chi2[28];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_ndof[28];   //[refitvertexwithbs_count]
   Int_t           refitvertexwithbs_ntracks[28];   //[refitvertexwithbs_count]
   Float_t         refitvertexwithbs_cov[28][6];   //[refitvertexwithbs_count]
   Int_t           refitvertexwithbs_eleIndex[28][2];   //[refitvertexwithbs_count]
   Int_t           refitvertexwithbs_muIndex[28][2];   //[refitvertexwithbs_count]
   Int_t           refitvertexwithbs_tauIndex[28][2];   //[refitvertexwithbs_count]
   UInt_t          muon_count;
   Float_t         muon_helixparameters[7][5];   //[muon_count]
   Float_t         muon_helixparameters_covar[7][5][5];   //[muon_count]
   Float_t         muon_referencePoint[7][3];   //[muon_count]
   Float_t         muon_Bfield[7];   //[muon_count]
   Float_t         muon_px[7];   //[muon_count]
   Float_t         muon_py[7];   //[muon_count]
   Float_t         muon_pz[7];   //[muon_count]
   Float_t         muon_pt[7];   //[muon_count]
   Float_t         muon_eta[7];   //[muon_count]
   Float_t         muon_phi[7];   //[muon_count]
   Float_t         muon_pterror[7];   //[muon_count]
   Float_t         muon_chi2[7];   //[muon_count]
   Float_t         muon_normChi2[7];   //[muon_count]
   Float_t         muon_ndof[7];   //[muon_count]
   Float_t         muon_charge[7];   //[muon_count]
   Float_t         muon_miniISO[7];   //[muon_count]
   Float_t         muon_combQ_chi2LocalPosition[7];   //[muon_count]
   Float_t         muon_combQ_trkKink[7];   //[muon_count]
   Float_t         muon_validFraction[7];   //[muon_count]
   Float_t         muon_segmentComp[7];   //[muon_count]
   UInt_t          muon_nMuonStations[7];   //[muon_count]
   UInt_t          muon_nMuonHits[7];   //[muon_count]
   UInt_t          muon_nPixelHits[7];   //[muon_count]
   UInt_t          muon_nTrackerHits[7];   //[muon_count]
   Float_t         muon_dxy[7];   //[muon_count]
   Float_t         muon_dxyerr[7];   //[muon_count]
   Float_t         muon_dz[7];   //[muon_count]
   Float_t         muon_dzerr[7];   //[muon_count]
   Float_t         muon_vx[7];   //[muon_count]
   Float_t         muon_vy[7];   //[muon_count]
   Float_t         muon_vz[7];   //[muon_count]
   Float_t         muon_chargedHadIso[7];   //[muon_count]
   Float_t         muon_neutralHadIso[7];   //[muon_count]
   Float_t         muon_photonIso[7];   //[muon_count]
   Float_t         muon_puIso[7];   //[muon_count]
   Float_t         muon_r03_sumChargedHadronPt[7];   //[muon_count]
   Float_t         muon_r03_sumChargedParticlePt[7];   //[muon_count]
   Float_t         muon_r03_sumNeutralHadronEt[7];   //[muon_count]
   Float_t         muon_r03_sumPhotonEt[7];   //[muon_count]
   Float_t         muon_r03_sumNeutralHadronEtHighThreshold[7];   //[muon_count]
   Float_t         muon_r03_sumPhotonEtHighThreshold[7];   //[muon_count]
   Float_t         muon_r03_sumPUPt[7];   //[muon_count]
   Float_t         muon_r04_sumChargedHadronPt[7];   //[muon_count]
   Float_t         muon_r04_sumChargedParticlePt[7];   //[muon_count]
   Float_t         muon_r04_sumNeutralHadronEt[7];   //[muon_count]
   Float_t         muon_r04_sumPhotonEt[7];   //[muon_count]
   Float_t         muon_r04_sumNeutralHadronEtHighThreshold[7];   //[muon_count]
   Float_t         muon_r04_sumPhotonEtHighThreshold[7];   //[muon_count]
   Float_t         muon_r04_sumPUPt[7];   //[muon_count]
   Bool_t          muon_isPF[7];   //[muon_count]
   Bool_t          muon_isGlobal[7];   //[muon_count]
   Bool_t          muon_isTracker[7];   //[muon_count]
   Bool_t          muon_isTight[7];   //[muon_count]
   Bool_t          muon_isLoose[7];   //[muon_count]
   Bool_t          muon_isMedium[7];   //[muon_count]
   Int_t           muon_genmatch[7];   //[muon_count]
   Bool_t          muon_isDuplicate[7];   //[muon_count]
   Bool_t          muon_isBad[7];   //[muon_count]
   Float_t         muon_ttHMVA[7];   //[muon_count]
   Float_t         muon_ttHMVA2016[7];   //[muon_count]
   UInt_t          pfjet_count;
   Float_t         pfjet_e[13];   //[pfjet_count]
   Float_t         pfjet_px[13];   //[pfjet_count]
   Float_t         pfjet_py[13];   //[pfjet_count]
   Float_t         pfjet_pz[13];   //[pfjet_count]
   Float_t         pfjet_pt[13];   //[pfjet_count]
   Float_t         pfjet_eta[13];   //[pfjet_count]
   Float_t         pfjet_phi[13];   //[pfjet_count]
   Float_t         pfjet_neutralhadronicenergy[13];   //[pfjet_count]
   Float_t         pfjet_chargedhadronicenergy[13];   //[pfjet_count]
   Float_t         pfjet_neutralemenergy[13];   //[pfjet_count]
   Float_t         pfjet_chargedemenergy[13];   //[pfjet_count]
   Float_t         pfjet_muonenergy[13];   //[pfjet_count]
   Float_t         pfjet_chargedmuonenergy[13];   //[pfjet_count]
   UInt_t          pfjet_chargedmulti[13];   //[pfjet_count]
   UInt_t          pfjet_neutralmulti[13];   //[pfjet_count]
   UInt_t          pfjet_chargedhadronmulti[13];   //[pfjet_count]
   Float_t         pfjet_energycorr[13];   //[pfjet_count]
   Float_t         pfjet_energycorr_l1fastjet[13];   //[pfjet_count]
   Float_t         pfjet_energycorr_l2relative[13];   //[pfjet_count]
   Float_t         pfjet_energycorr_l3absolute[13];   //[pfjet_count]
   Float_t         pfjet_energycorr_l2l3residual[13];   //[pfjet_count]
   Int_t           pfjet_flavour[13];   //[pfjet_count]
   Float_t         pfjet_btag[13][10];   //[pfjet_count]
   Float_t         pfjet_jecUncertainty[13];   //[pfjet_count]
   Float_t         pfjet_pu_jet_fullDisc_mva[13];   //[pfjet_count]
   UInt_t          pfjetpuppi_count;
   Float_t         pfjetpuppi_e[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_px[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_py[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_pz[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_pt[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_eta[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_phi[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_neutralhadronicenergy[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_chargedhadronicenergy[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_neutralemenergy[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_chargedemenergy[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_muonenergy[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_chargedmuonenergy[10];   //[pfjetpuppi_count]
   UInt_t          pfjetpuppi_chargedmulti[10];   //[pfjetpuppi_count]
   UInt_t          pfjetpuppi_neutralmulti[10];   //[pfjetpuppi_count]
   UInt_t          pfjetpuppi_chargedhadronmulti[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr_l1fastjet[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr_l2relative[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr_l3absolute[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_energycorr_l2l3residual[10];   //[pfjetpuppi_count]
   Int_t           pfjetpuppi_flavour[10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_btag[10][10];   //[pfjetpuppi_count]
   Float_t         pfjetpuppi_jecUncertainty[10];   //[pfjetpuppi_count]
   UInt_t          electron_count;
   Float_t         electron_helixparameters[4][5];   //[electron_count]
   Float_t         electron_helixparameters_covar[4][5][5];   //[electron_count]
   Float_t         electron_referencePoint[4][3];   //[electron_count]
   Float_t         electron_Bfield[4];   //[electron_count]
   Float_t         electron_px[4];   //[electron_count]
   Float_t         electron_py[4];   //[electron_count]
   Float_t         electron_pz[4];   //[electron_count]
   Float_t         electron_pt[4];   //[electron_count]
   Float_t         electron_eta[4];   //[electron_count]
   Float_t         electron_phi[4];   //[electron_count]
   Float_t         electron_px_energyscale_up[4];   //[electron_count]
   Float_t         electron_px_energyscale_down[4];   //[electron_count]
   Float_t         electron_py_energyscale_up[4];   //[electron_count]
   Float_t         electron_py_energyscale_down[4];   //[electron_count]
   Float_t         electron_pz_energyscale_up[4];   //[electron_count]
   Float_t         electron_pz_energyscale_down[4];   //[electron_count]
   Float_t         electron_pt_energyscale_up[4];   //[electron_count]
   Float_t         electron_pt_energyscale_down[4];   //[electron_count]
   Float_t         electron_px_energysigma_up[4];   //[electron_count]
   Float_t         electron_px_energysigma_down[4];   //[electron_count]
   Float_t         electron_py_energysigma_up[4];   //[electron_count]
   Float_t         electron_py_energysigma_down[4];   //[electron_count]
   Float_t         electron_pz_energysigma_up[4];   //[electron_count]
   Float_t         electron_pz_energysigma_down[4];   //[electron_count]
   Float_t         electron_pt_energysigma_up[4];   //[electron_count]
   Float_t         electron_pt_energysigma_down[4];   //[electron_count]
   Float_t         electron_trackchi2[4];   //[electron_count]
   Float_t         electron_trackndof[4];   //[electron_count]
   Float_t         electron_outerx[4];   //[electron_count]
   Float_t         electron_outery[4];   //[electron_count]
   Float_t         electron_outerz[4];   //[electron_count]
   Float_t         electron_vx[4];   //[electron_count]
   Float_t         electron_vy[4];   //[electron_count]
   Float_t         electron_vz[4];   //[electron_count]
   Float_t         electron_esuperclusterovertrack[4];   //[electron_count]
   Float_t         electron_eseedclusterovertrack[4];   //[electron_count]
   Float_t         electron_deltaetasuperclustertrack[4];   //[electron_count]
   Float_t         electron_deltaphisuperclustertrack[4];   //[electron_count]
   Float_t         electron_e1x5[4];   //[electron_count]
   Float_t         electron_e2x5[4];   //[electron_count]
   Float_t         electron_e5x5[4];   //[electron_count]
   Float_t         electron_sigmaetaeta[4];   //[electron_count]
   Float_t         electron_sigmaietaieta[4];   //[electron_count]
   Float_t         electron_ehcaloverecal[4];   //[electron_count]
   Float_t         electron_ehcaloverecaldepth1[4];   //[electron_count]
   Float_t         electron_ehcaloverecaldepth2[4];   //[electron_count]
   Float_t         electron_full5x5_sigmaietaieta[4];   //[electron_count]
   Float_t         electron_ooemoop[4];   //[electron_count]
   Float_t         electron_miniISO[4];   //[electron_count]
   Float_t         electron_superclusterEta[4];   //[electron_count]
   Float_t         electron_superclusterPhi[4];   //[electron_count]
   Float_t         electron_superclusterX[4];   //[electron_count]
   Float_t         electron_superclusterY[4];   //[electron_count]
   Float_t         electron_superclusterZ[4];   //[electron_count]
   Float_t         electron_detaInSeed[4];   //[electron_count]
   Float_t         electron_he[4];   //[electron_count]
   Float_t         electron_eaIsolation[4];   //[electron_count]
   Float_t         electron_chargedHadIso[4];   //[electron_count]
   Float_t         electron_neutralHadIso[4];   //[electron_count]
   Float_t         electron_photonIso[4];   //[electron_count]
   Float_t         electron_puIso[4];   //[electron_count]
   Float_t         electron_r03_sumChargedHadronPt[4];   //[electron_count]
   Float_t         electron_r03_sumChargedParticlePt[4];   //[electron_count]
   Float_t         electron_r03_sumNeutralHadronEt[4];   //[electron_count]
   Float_t         electron_r03_sumPhotonEt[4];   //[electron_count]
   Float_t         electron_r03_sumNeutralHadronEtHighThreshold[4];   //[electron_count]
   Float_t         electron_r03_sumPhotonEtHighThreshold[4];   //[electron_count]
   Float_t         electron_r03_sumPUPt[4];   //[electron_count]
   UChar_t         electron_nhits[4];   //[electron_count]
   UChar_t         electron_npixelhits[4];   //[electron_count]
   UChar_t         electron_nmissinghits[4];   //[electron_count]
   UChar_t         electron_nmissinginnerhits[4];   //[electron_count]
   UChar_t         electron_npixellayers[4];   //[electron_count]
   UChar_t         electron_nstriplayers[4];   //[electron_count]
   Float_t         electron_dxy[4];   //[electron_count]
   Float_t         electron_dxyerr[4];   //[electron_count]
   Float_t         electron_dz[4];   //[electron_count]
   Float_t         electron_dzerr[4];   //[electron_count]
   Float_t         electron_convdist[4];   //[electron_count]
   UInt_t          electron_gapinfo[4];   //[electron_count]
   UInt_t          electron_chargeinfo[4];   //[electron_count]
   Float_t         electron_fbrems[4];   //[electron_count]
   Int_t           electron_numbrems[4];   //[electron_count]
   Float_t         electron_charge[4];   //[electron_count]
   Int_t           electron_superclusterindex[4];   //[electron_count]
   UChar_t         electron_info[4];   //[electron_count]
   Bool_t          electron_cutId_veto_Summer16[4];   //[electron_count]
   Float_t         electron_mva_value_Spring16_v1[4];   //[electron_count]
   Float_t         electron_mva_wp90_general_Spring16_v1[4];   //[electron_count]
   Float_t         electron_mva_wp80_general_Spring16_v1[4];   //[electron_count]
   Float_t         electron_mva_value_Iso_Fall17_v1[4];   //[electron_count]
   Float_t         electron_mva_value_noIso_Fall17_v1[4];   //[electron_count]
   Float_t         electron_mva_wp90_Iso_Fall17_v1[4];   //[electron_count]
   Float_t         electron_mva_wp80_Iso_Fall17_v1[4];   //[electron_count]
   Float_t         electron_mva_Loose_Iso_Fall17_v1[4];   //[electron_count]
   Float_t         electron_mva_wp90_noIso_Fall17_v1[4];   //[electron_count]
   Float_t         electron_mva_wp80_noIso_Fall17_v1[4];   //[electron_count]
   Float_t         electron_mva_Loose_noIso_Fall17_v1[4];   //[electron_count]
   Float_t         electron_mva_value_Iso_Fall17_v2[4];   //[electron_count]
   Float_t         electron_mva_value_noIso_Fall17_v2[4];   //[electron_count]
   Float_t         electron_mva_wp90_Iso_Fall17_v2[4];   //[electron_count]
   Float_t         electron_mva_wp80_Iso_Fall17_v2[4];   //[electron_count]
   Float_t         electron_mva_Loose_Iso_Fall17_v2[4];   //[electron_count]
   Float_t         electron_mva_wp90_noIso_Fall17_v2[4];   //[electron_count]
   Float_t         electron_mva_wp80_noIso_Fall17_v2[4];   //[electron_count]
   Float_t         electron_mva_Loose_noIso_Fall17_v2[4];   //[electron_count]
   Bool_t          electron_cutId_veto_Fall17[4];   //[electron_count]
   Bool_t          electron_cutId_veto_Fall17V2[4];   //[electron_count]
   Float_t         electron_ttHMVA[4];   //[electron_count]
   Float_t         electron_ttHMVA2016[4];   //[electron_count]
   Bool_t          electron_pass_conversion[4];   //[electron_count]
   Int_t           electron_genmatch[4];   //[electron_count]
   UInt_t          tau_count;
   Float_t         tau_helixparameters[6][5];   //[tau_count]
   Float_t         tau_helixparameters_covar[6][5][5];   //[tau_count]
   Float_t         tau_referencePoint[6][3];   //[tau_count]
   Float_t         tau_Bfield[6];   //[tau_count]
   ...
   Float_t         tau_pca2D_x[6];   //[tau_count]
   Float_t         tau_pca2D_y[6];   //[tau_count]
   Float_t         tau_pca2D_z[6];   //[tau_count]
   Float_t         tau_pca3D_x[6];   //[tau_count]
   Float_t         tau_pca3D_y[6];   //[tau_count]
   Float_t         tau_pca3D_z[6];   //[tau_count]
   Float_t         tau_dxy[6];   //[tau_count]
   Float_t         tau_dxySig[6];   //[tau_count]
   Float_t         tau_dz[6];   //[tau_count]
   Float_t         tau_ip3d[6];   //[tau_count]
   Float_t         tau_ip3dSig[6];   //[tau_count]
   Float_t         tau_charge[6];   //[tau_count]
   Float_t         tau_flightLength[6];   //[tau_count]
   Float_t         tau_flightLengthSig[6];   //[tau_count]
   Float_t         tau_SV_x[6];   //[tau_count]
   Float_t         tau_SV_y[6];   //[tau_count]
   Float_t         tau_SV_z[6];   //[tau_count]
   Float_t         tau_SV_cov[6][6];   //[tau_count]
   ...
   Int_t           tau_genmatch[6];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_px[6];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_py[6];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_pz[6];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_mass[6];   //[tau_count]
   Int_t           tau_leadchargedhadrcand_id[6];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_dxy[6];   //[tau_count]
   Float_t         tau_leadchargedhadrcand_dz[6];   //[tau_count]
   Int_t           tau_leadchargedhadrcand_lostPixelHits[6];   //[tau_count]
   Int_t           tau_leadchargedhadrcand_pvAssocQ[6];   //[tau_count]
   ...
   UInt_t          tau_constituents_count[6];   //[tau_count]
   Float_t         tau_constituents_px[6][50];   //[tau_count]
   Float_t         tau_constituents_py[6][50];   //[tau_count]
   Float_t         tau_constituents_pz[6][50];   //[tau_count]
   Float_t         tau_constituents_e[6][50];   //[tau_count]
   Float_t         tau_constituents_mass[6][50];   //[tau_count]
   Int_t           tau_constituents_charge[6][50];   //[tau_count]
   Float_t         tau_constituents_vx[6][50];   //[tau_count]
   Float_t         tau_constituents_vy[6][50];   //[tau_count]
   Float_t         tau_constituents_vz[6][50];   //[tau_count]
   Int_t           tau_constituents_pdgId[6][50];   //[tau_count]
   Int_t           tau_constituents_lostPixelHits[6][50];   //[tau_count]
   UInt_t          track_count;
   Float_t         track_px[154];   //[track_count]
   Float_t         track_py[154];   //[track_count]
   Float_t         track_pz[154];   //[track_count]
   Float_t         track_pt[154];   //[track_count]
   Float_t         track_eta[154];   //[track_count]
   Float_t         track_phi[154];   //[track_count]
   Float_t         track_charge[154];   //[track_count]
   Float_t         track_mass[154];   //[track_count]
   Float_t         track_dxy[154];   //[track_count]
   Float_t         track_dxyerr[154];   //[track_count]
   Float_t         track_dz[154];   //[track_count]
   Float_t         track_dzerr[154];   //[track_count]
   Float_t         track_vx[154];   //[track_count]
   Float_t         track_vy[154];   //[track_count]
   Float_t         track_vz[154];   //[track_count]
   Int_t           track_ID[154];   //[track_count]
   Bool_t          track_highPurity[154];   //[track_count]
   ...
   Float_t         genweight;
   UInt_t          gentau_count;
   Float_t         gentau_e[5];   //[gentau_count]
   Float_t         gentau_charge[5];   //[gentau_count]
   Float_t         gentau_px[5];   //[gentau_count]
   Float_t         gentau_py[5];   //[gentau_count]
   Float_t         gentau_pz[5];   //[gentau_count]
   Float_t         gentau_visible_e[5];   //[gentau_count]
   Float_t         gentau_visible_px[5];   //[gentau_count]
   Float_t         gentau_visible_py[5];   //[gentau_count]
   Float_t         gentau_visible_pz[5];   //[gentau_count]
   Float_t         gentau_visible_pt[5];   //[gentau_count]
   Float_t         gentau_visible_eta[5];   //[gentau_count]
   Float_t         gentau_visible_phi[5];   //[gentau_count]
   Float_t         gentau_visible_mass[5];   //[gentau_count]
   Float_t         gentau_vx[5];   //[gentau_count]
   Float_t         gentau_vy[5];   //[gentau_count]
   Float_t         gentau_vz[5];   //[gentau_count]
   Float_t         gentau_visibleNoLep_e[5];   //[gentau_count]
   Float_t         gentau_visibleNoLep_pt[5];   //[gentau_count]
   Float_t         gentau_visibleNoLep_eta[5];   //[gentau_count]
   Float_t         gentau_visibleNoLep_phi[5];   //[gentau_count]
   Float_t         gentau_visibleNoLep_mass[5];   //[gentau_count]
   Int_t           gentau_status[5];   //[gentau_count]
   Int_t           gentau_fromHardProcess[5];   //[gentau_count]
   Int_t           gentau_fromHardProcessBeforeFSR[5];   //[gentau_count]
   Int_t           gentau_isDecayedLeptonHadron[5];   //[gentau_count]
   Int_t           gentau_isDirectHadronDecayProduct[5];   //[gentau_count]
   Int_t           gentau_isDirectHardProcessTauDecayProduct[5];   //[gentau_count]
   Int_t           gentau_isDirectPromptTauDecayProduct[5];   //[gentau_count]
   Int_t           gentau_isDirectTauDecayProduct[5];   //[gentau_count]
   Int_t           gentau_isFirstCopy[5];   //[gentau_count]
   Int_t           gentau_isHardProcess[5];   //[gentau_count]
   Int_t           gentau_isHardProcessTauDecayProduct[5];   //[gentau_count]
   Int_t           gentau_isLastCopy[5];   //[gentau_count]
   Int_t           gentau_isLastCopyBeforeFSR[5];   //[gentau_count]
   Int_t           gentau_isPrompt[5];   //[gentau_count]
   Int_t           gentau_isPromptTauDecayProduct[5];   //[gentau_count]
   Int_t           gentau_isTauDecayProduct[5];   //[gentau_count]
   Int_t           gentau_decayMode[5];   //[gentau_count]
   Char_t          gentau_decayMode_name[5];   //[gentau_count]
   UChar_t         gentau_mother[5];   //[gentau_count]
   ...
   Float_t         genparticles_e[63];   //[genparticles_count]
   Float_t         genparticles_px[63];   //[genparticles_count]
   Float_t         genparticles_py[63];   //[genparticles_count]
   Float_t         genparticles_pz[63];   //[genparticles_count]
   Float_t         genparticles_vx[63];   //[genparticles_count]
   Float_t         genparticles_vy[63];   //[genparticles_count]
   Float_t         genparticles_vz[63];   //[genparticles_count]
   Int_t           genparticles_pdgid[63];   //[genparticles_count]
   Int_t           genparticles_status[63];   //[genparticles_count]
   UInt_t          genparticles_info[63];   //[genparticles_count]
   Int_t           genparticles_fromHardProcess[63];   //[genparticles_count]
   Int_t           genparticles_fromHardProcessBeforeFSR[63];   //[genparticles_count]
   Int_t           genparticles_isDecayedLeptonHadron[63];   //[genparticles_count]
   Int_t           genparticles_isDirectHadronDecayProduct[63];   //[genparticles_count]
   Int_t           genparticles_isDirectHardProcessTauDecayProduct[63];   //[genparticles_count]
   Int_t           genparticles_isDirectPromptTauDecayProduct[63];   //[genparticles_count]
   Int_t           genparticles_isDirectTauDecayProduct[63];   //[genparticles_count]
   Int_t           genparticles_isFirstCopy[63];   //[genparticles_count]
   Int_t           genparticles_isHardProcess[63];   //[genparticles_count]
   Int_t           genparticles_isHardProcessTauDecayProduct[63];   //[genparticles_count]
   Int_t           genparticles_isLastCopy[63];   //[genparticles_count]
   Int_t           genparticles_isLastCopyBeforeFSR[63];   //[genparticles_count]
   Int_t           genparticles_isPrompt[63];   //[genparticles_count]
   Int_t           genparticles_isPromptTauDecayProduct[63];   //[genparticles_count]
   Int_t           genparticles_isTauDecayProduct[63];   //[genparticles_count]
   UChar_t         genparticles_mother[63];   //[genparticles_count]
   UInt_t          genjets_count;
   Float_t         genjets_e[20];   //[genjets_count]
   Float_t         genjets_px[20];   //[genjets_count]
   Float_t         genjets_py[20];   //[genjets_count]
   Float_t         genjets_pz[20];   //[genjets_count]
   Float_t         genjets_pt[20];   //[genjets_count]
   Float_t         genjets_eta[20];   //[genjets_count]
   Float_t         genjets_phi[20];   //[genjets_count]
   Int_t           genjets_pdgid[20];   //[genjets_count]
   Int_t           genjets_status[20];   //[genjets_count]
   Float_t         genjets_em_energy[20];   //[genjets_count]
   Float_t         genjets_had_energy[20];   //[genjets_count]
   Float_t         genjets_invisible_energy[20];   //[genjets_count]
   Float_t         genjets_auxiliary_energy[20];   //[genjets_count]
   ...
   Float_t         l1egamma_px[5];   //[l1egamma_count]
   Float_t         l1egamma_py[5];   //[l1egamma_count]
   Float_t         l1egamma_pz[5];   //[l1egamma_count]
   Float_t         l1egamma_pt[5];   //[l1egamma_count]
   Int_t           l1egamma_eta[5];   //[l1egamma_count]
   Int_t           l1egamma_phi[5];   //[l1egamma_count]
   Int_t           l1egamma_iso[5];   //[l1egamma_count]
   UInt_t          l1tau_count;
   Float_t         l1tau_px[10];   //[l1tau_count]
   Float_t         l1tau_py[10];   //[l1tau_count]
   Float_t         l1tau_pz[10];   //[l1tau_count]
   Float_t         l1tau_pt[10];   //[l1tau_count]
   Int_t           l1tau_ipt[10];   //[l1tau_count]
   Int_t           l1tau_eta[10];   //[l1tau_count]
   Int_t           l1tau_phi[10];   //[l1tau_count]
   Int_t           l1tau_qual[10];   //[l1tau_count]
   Int_t           l1tau_iso[10];   //[l1tau_count]
   Int_t           l1tau_towerIEta[10];   //[l1tau_count]
   Int_t           l1tau_towerIPhi[10];   //[l1tau_count]
   Int_t           l1tau_rawEt[10];   //[l1tau_count]
   Int_t           l1tau_isoEt[10];   //[l1tau_count]
   Int_t           l1tau_nTT[10];   //[l1tau_count]
   Int_t           l1tau_hasEM[10];   //[l1tau_count]
   Int_t           l1tau_isMerged[10];   //[l1tau_count]
   Int_t           l1tau_bx[10];   //[l1tau_count]
   UInt_t          l1isotau_count;
   Float_t         l1isotau_e[1];   //[l1isotau_count]
   Float_t         l1isotau_px[1];   //[l1isotau_count]
   Float_t         l1isotau_py[1];   //[l1isotau_count]
   Float_t         l1isotau_pz[1];   //[l1isotau_count]
   Float_t         l1isotau_mass[1];   //[l1isotau_count]
   Float_t         l1isotau_eta[1];   //[l1isotau_count]
   Float_t         l1isotau_phi[1];   //[l1isotau_count]
   Float_t         l1isotau_pt[1];   //[l1isotau_count]
   Float_t         l1isotau_charge[1];   //[l1isotau_count]
   Int_t           l1isotau_iso[1];   //[l1isotau_count]
   UInt_t          trigobject_count;
   Float_t         trigobject_px[17];   //[trigobject_count]
   Float_t         trigobject_py[17];   //[trigobject_count]
   Float_t         trigobject_pz[17];   //[trigobject_count]
   Float_t         trigobject_pt[17];   //[trigobject_count]
   Float_t         trigobject_eta[17];   //[trigobject_count]
   Float_t         trigobject_phi[17];   //[trigobject_count]
   Bool_t          trigobject_filters[17][200];   //[trigobject_count]
   Bool_t          trigobject_isMuon[17];   //[trigobject_count]
   Bool_t          trigobject_isElectron[17];   //[trigobject_count]
   Bool_t          trigobject_isTau[17];   //[trigobject_count]
   Bool_t          trigobject_isJet[17];   //[trigobject_count]
   Bool_t          trigobject_isMET[17];   //[trigobject_count]
   ...
   map<string,int> *hltriggerresults;
   map<string,int> *hltriggerprescales;
   ...
   Float_t         tau_againstElectronDeadECAL[6];   //[tau_count]
   Float_t         tau_againstElectronLooseMVA6[6];   //[tau_count]
   Float_t         tau_againstElectronMVA6Raw[6];   //[tau_count]
   Float_t         tau_againstElectronMVA6category[6];   //[tau_count]
   Float_t         tau_againstElectronMediumMVA6[6];   //[tau_count]
   Float_t         tau_againstElectronTightMVA6[6];   //[tau_count]
   Float_t         tau_againstElectronVLooseMVA6[6];   //[tau_count]
   Float_t         tau_againstElectronVTightMVA6[6];   //[tau_count]
   ...
   Float_t         tau_byIsolationMVArun2v1DBdR03oldDMwLTraw[6];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1DBnewDMwLTraw[6];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1DBoldDMwLTraw[6];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1PWdR03oldDMwLTraw[6];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1PWnewDMwLTraw[6];   //[tau_count]
   Float_t         tau_byIsolationMVArun2v1PWoldDMwLTraw[6];   //[tau_count]
   Float_t         tau_byLooseCombinedIsolationDeltaBetaCorr3Hits[6];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1DBdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1DBnewDMwLT[6];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1DBoldDMwLT[6];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1PWdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1PWnewDMwLT[6];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2v1PWoldDMwLT[6];   //[tau_count]
   Float_t         tau_byMediumCombinedIsolationDeltaBetaCorr3Hits[6];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1DBdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1DBnewDMwLT[6];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1DBoldDMwLT[6];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1PWdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1PWnewDMwLT[6];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2v1PWoldDMwLT[6];   //[tau_count]
   Float_t         tau_byPhotonPtSumOutsideSignalCone[6];   //[tau_count]
   Float_t         tau_byTightCombinedIsolationDeltaBetaCorr3Hits[6];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1DBdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1DBnewDMwLT[6];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1DBoldDMwLT[6];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1PWdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1PWnewDMwLT[6];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2v1PWoldDMwLT[6];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1DBdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1DBnewDMwLT[6];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1DBoldDMwLT[6];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1PWdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1PWnewDMwLT[6];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2v1PWoldDMwLT[6];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1DBdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1DBnewDMwLT[6];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1DBoldDMwLT[6];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1PWdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1PWnewDMwLT[6];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2v1PWoldDMwLT[6];   //[tau_count]
   Float_t         tau_byVVLooseIsolationMVArun2v1DBdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byVVLooseIsolationMVArun2v1DBnewDMwLT[6];   //[tau_count]
   Float_t         tau_byVVLooseIsolationMVArun2v1DBoldDMwLT[6];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1DBdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1DBnewDMwLT[6];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1DBoldDMwLT[6];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1PWdR03oldDMwLT[6];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1PWnewDMwLT[6];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2v1PWoldDMwLT[6];   //[tau_count]
   Float_t         tau_chargedIsoPtSum[6];   //[tau_count]
   Float_t         tau_chargedIsoPtSumdR03[6];   //[tau_count]
   Float_t         tau_decayModeFinding[6];   //[tau_count]
   Float_t         tau_decayModeFindingNewDMs[6];   //[tau_count]
   Float_t         tau_footprintCorrection[6];   //[tau_count]
   Float_t         tau_footprintCorrectiondR03[6];   //[tau_count]
   Float_t         tau_neutralIsoPtSum[6];   //[tau_count]
   Float_t         tau_neutralIsoPtSumWeight[6];   //[tau_count]
   Float_t         tau_neutralIsoPtSumWeightdR03[6];   //[tau_count]
   Float_t         tau_neutralIsoPtSumdR03[6];   //[tau_count]
   Float_t         tau_photonPtSumOutsideSignalCone[6];   //[tau_count]
   Float_t         tau_photonPtSumOutsideSignalConedR03[6];   //[tau_count]
   Float_t         tau_puCorrPtSum[6];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSeraw[6];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSjetraw[6];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSmuraw[6];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSmu[6];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSmu[6];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSmu[6];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSmu[6];   //[tau_count]
   Float_t         tau_byVTightDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVTightDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byVVLooseDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVVLooseDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byVVTightDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVVTightDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byVVVLooseDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVVVLooseDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSeraw[6];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSjetraw[6];   //[tau_count]
   Float_t         tau_byDeepTau2017v2p1VSmuraw[6];   //[tau_count]
   Float_t         tau_byIsolationMVArun2017v2DBoldDMwLTraw2017[6];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byLooseDeepTau2017v2p1VSmu[6];   //[tau_count]
   Float_t         tau_byLooseIsolationMVArun2017v2DBoldDMwLT2017[6];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byMediumDeepTau2017v2p1VSmu[6];   //[tau_count]
   Float_t         tau_byMediumIsolationMVArun2017v2DBoldDMwLT2017[6];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byTightDeepTau2017v2p1VSmu[6];   //[tau_count]
   Float_t         tau_byTightIsolationMVArun2017v2DBoldDMwLT2017[6];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byVLooseDeepTau2017v2p1VSmu[6];   //[tau_count]
   Float_t         tau_byVLooseIsolationMVArun2017v2DBoldDMwLT2017[6];   //[tau_count]
   Float_t         tau_byVTightDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVTightDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byVTightIsolationMVArun2017v2DBoldDMwLT2017[6];   //[tau_count]
   Float_t         tau_byVVLooseDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVVLooseDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byVVLooseIsolationMVArun2017v2DBoldDMwLT2017[6];   //[tau_count]
   Float_t         tau_byVVTightDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVVTightDeepTau2017v2p1VSjet[6];   //[tau_count]
   Float_t         tau_byVVTightIsolationMVArun2017v2DBoldDMwLT2017[6];   //[tau_count]
   Float_t         tau_byVVVLooseDeepTau2017v2p1VSe[6];   //[tau_count]
   Float_t         tau_byVVVLooseDeepTau2017v2p1VSjet[6];   //[tau_count]
   ...
   TBranch        *b_muon_ttHMVA;   //!
   TBranch        *b_muon_ttHMVA2016;   //!
   ...
   TBranch        *b_electron_ttHMVA;   //!
   TBranch        *b_electron_ttHMVA2016;   //!
   ...
   TBranch        *b_prefiringweightECAL;   //!
   TBranch        *b_prefiringweightECALup;   //!
   TBranch        *b_prefiringweightECALdown;   //!
   TBranch        *b_prefiringweightMuon;   //!
   TBranch        *b_prefiringweightMuonup;   //!
   TBranch        *b_prefiringweightMuondown;   //!
   TBranch        *b_prefiringweightMuonSystup;   //!
   TBranch        *b_prefiringweightMuonSystdown;   //!
   TBranch        *b_prefiringweightMuonStatup;   //!
   TBranch        *b_prefiringweightMuonStatdown;   //!
   TBranch        *b_tau_againstElectronDeadECAL;   //!
   ...
   TBranch        *b_tau_byVVLooseIsolationMVArun2v1DBdR03oldDMwLT;   //!
   TBranch        *b_tau_byVVLooseIsolationMVArun2v1DBnewDMwLT;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/pnfs/desy.de/cms/tier2/store/user/acardini/ntuples/Oktoberfest21/2018/mc/DYJetsToLL_M-50_amcatnlo/DYJetsToLL_M-50_amcatnlo_21005.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/pnfs/desy.de/cms/tier2/store/user/acardini/ntuples/Oktoberfest21/2018/mc/DYJetsToLL_M-50_amcatnlo/DYJetsToLL_M-50_amcatnlo_21005.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/pnfs/desy.de/cms/tier2/store/user/acardini/ntuples/Oktoberfest21/2018/mc/DYJetsToLL_M-50_amcatnlo/DYJetsToLL_M-50_amcatnlo_21005.root:/makeroottree");
...
void AC1B::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("muon_ttHMVA", muon_ttHMVA, &b_muon_ttHMVA);
   fChain->SetBranchAddress("muon_ttHMVA2016", muon_ttHMVA2016, &b_muon_ttHMVA2016);
   ...
   fChain->SetBranchAddress("electron_ttHMVA", electron_ttHMVA, &b_electron_ttHMVA);
   fChain->SetBranchAddress("electron_ttHMVA2016", electron_ttHMVA2016, &b_electron_ttHMVA2016);
   ...
   fChain->SetBranchAddress("gentau_vx", gentau_vx, &b_gentau_vx);
   fChain->SetBranchAddress("gentau_vy", gentau_vy, &b_gentau_vy);
   fChain->SetBranchAddress("gentau_vz", gentau_vz, &b_gentau_vz);
   ...
   fChain->SetBranchAddress("prefiringweightECAL", &prefiringweightECAL, &b_prefiringweightECAL);
   fChain->SetBranchAddress("prefiringweightECALup", &prefiringweightECALup, &b_prefiringweightECALup);
   fChain->SetBranchAddress("prefiringweightECALdown", &prefiringweightECALdown, &b_prefiringweightECALdown);
   fChain->SetBranchAddress("prefiringweightMuon", &prefiringweightMuon, &b_prefiringweightMuon);
   fChain->SetBranchAddress("prefiringweightMuonup", &prefiringweightMuonup, &b_prefiringweightMuonup);
   fChain->SetBranchAddress("prefiringweightMuondown", &prefiringweightMuondown, &b_prefiringweightMuondown);
   fChain->SetBranchAddress("prefiringweightMuonSystup", &prefiringweightMuonSystup, &b_prefiringweightMuonSystup);
   fChain->SetBranchAddress("prefiringweightMuonSystdown", &prefiringweightMuonSystdown, &b_prefiringweightMuonSystdown);
   fChain->SetBranchAddress("prefiringweightMuonStatup", &prefiringweightMuonStatup, &b_prefiringweightMuonStatup);
   fChain->SetBranchAddress("prefiringweightMuonStatdown", &prefiringweightMuonStatdown, &b_prefiringweightMuonStatdown);
   fChain->SetBranchAddress("tau_againstElectronDeadECAL", tau_againstElectronDeadECAL, &b_tau_againstElectronDeadECAL);
   ...
   fChain->SetBranchAddress("tau_byVVLooseIsolationMVArun2v1DBdR03oldDMwLT", tau_byVVLooseIsolationMVArun2v1DBdR03oldDMwLT, &b_tau_byVVLooseIsolationMVArun2v1DBdR03oldDMwLT);
   fChain->SetBranchAddress("tau_byVVLooseIsolationMVArun2v1DBnewDMwLT", tau_byVVLooseIsolationMVArun2v1DBnewDMwLT, &b_tau_byVVLooseIsolationMVArun2v1DBnewDMwLT);
