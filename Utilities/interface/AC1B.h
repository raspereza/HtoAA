...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         pfjet_e_uncorr[200];   //[pfjet_count]
   Float_t         pfjet_px_uncorr[200];   //[pfjet_count]
   Float_t         pfjet_py_uncorr[200];   //[pfjet_count]
   Float_t         pfjet_pz_uncorr[200];   //[pfjet_count]
